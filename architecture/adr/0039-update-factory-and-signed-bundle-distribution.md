...
**Status:** accepted  
**Date:** 2026-04-30  
**Owner:** update-factory-owner  
**Version context:** v3.2.5.0 consolidation promotion  
**Source classification:** v3.2.4.6 staged subtree ADR, mechanically normalized for current ADR format
## Review metadata
...
```
zovark update verify {bundle_path}
```
