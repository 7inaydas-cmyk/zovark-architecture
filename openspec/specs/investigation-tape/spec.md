...
## Purpose
Defines the investigation tape — Zovark's central recorded object — including required fields, the one-way `recording → closed` lifecycle, the customer-facing surface, and MVP-required vs. post-MVP field classification.
## Requirements
