...
| `architecture/adr-index.md` | Current ADR status index | Lists visible patch ADRs 0038-0043 and placeholder baseline ADRs 0011, 0024, 0025, 0027, 0028, 0030, 0031, 0034. |
